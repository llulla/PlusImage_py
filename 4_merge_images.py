...
def merge_image():
    ...
    max_widths, total_heigts = max(widths), sum(heights)
    # print("max widths : ",max_widths, "total heigth : ",total_heigts)

    result_img = Image.new("RGB", (max_widths, total_heigts), (255,255,255)) #배경 휜색
    y_offset = 0 #y 위치 정보
    # for img in images:
    ...
    dest_path = os.path.join(txt_dest_path.get(), "Plus_Image.jpg")
